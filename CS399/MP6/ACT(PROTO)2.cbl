      ...
      ******************************************************************
       ...
       *>THE INPUT FILE FOR READING
       FD INPUT-FILE.
       01 NEW-FILE.
           05 LOT_NUMBER_DISPLAY PIC 999999999.
           05 SPACE-01-DISPLAY PIC X(3).
           05 OWNER_NAME_DISPLAY PIC A(26).
           05 SPACE-02-DISPLAY PIC X(3).
           05 ASSESSED_VAL_DISPLAY PIC 999999V99.
           05 SPACE-03-DISPLAY PIC X(4).
       ...
       01 DATA_SCREEN.
           ...
           05 UPDATE-SCREEN.
               10 VALUE "UPDATE" BLANK SCREEN LINE 1 COL 30.
               10 VALUE "[1] CHANGE OWNER NAME" LINE 3 COL 12.
               10 VALUE "[2] CHANGE ASSSESSED VALUATION" LINE 5 COL 12.
           10 VALUE "[3] CHANGE BOTH OWNER AND VALUATION" LINE 7 COL 12.
               10 VALUE "[4] ADD TO TAX ROLLS " LINE 9 COL 12.
               10 VALUE "[5] REMOVE FROM TAX ROLLS" LINE 11 COL 12.
               10 VALUE "[6] BACK" LINE 13 COL 12.
               10 VALUE "ENTER CHOICE: " LINE 15  COL 12.
       ...
       B-200-OPTION3-UPDATE.
           ...
           ACCEPT OPTION-UPDATE LINE 15 COL 27.
           *>PERFORM INNER-A100 UNTIL OPTION_CREATE = "B".

           IF OPTION-UPDATE = 6 THEN
               PERFORM A-50-INITIALIZE
           ELSE IF OPTION-UPDATE IS NOT NUMERIC THEN
               PERFORM READ-PARA-EXIT
           END-IF.
       ...
       DISPLAY-INTEL.
           ...
           MOVE ZERO TO LOT_NUMBER_DISPLAY
           READ INPUT-FILE
           AT END
           MOVE 'Y' TO WS-EOF
           NOT AT END
